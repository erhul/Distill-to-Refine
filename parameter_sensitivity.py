...
if __name__ == "__main__":
    ...
    if args.distill:
        ...
        if args.T in [1.0, 2.0, 4.0, 5.0, 10.0, 20.0]:
            args.output_dir = osp.join(args.output, args.net_src + '_' + args.net, str(args.seed), args.da, args.dset,
                                       names[args.s][0].upper() + names[args.t][0].upper(), str(args.T))
        elif args.num_neighbors in [3, 5, 10, 16, 24, 32]:
            args.output_dir = osp.join(args.output, args.net_src + '_' + args.net, str(args.seed), args.da, args.dset,
                                       names[args.s][0].upper() + names[args.t][0].upper(), str(args.num_neighbors)+'00')
        else:
            args.output_dir = osp.join(args.output, args.net_src + '_' + args.net, str(args.seed), args.da, args.dset,
