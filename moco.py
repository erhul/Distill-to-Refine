...
class AdaMoCo(nn.Module):
    ...
    @torch.no_grad()
    def update_memory(self, epoch, idxs, keys, pseudo_labels):
    ...
    def forward(self, im_q, im_k=None, cls_only=False):
        ...
        feats_k, logits_k = self.src_model(im_k)
        q2 = F.normalize(feats_k, dim=1)
        ...
        return logits_q, logits_ins, k, logits_k, q, q2
        # return logits_q, logits_ins, k, logits_k
